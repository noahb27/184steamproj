...
historical_prices <- historical_prices %>%
  ...
  mutate(price = pmax(price, 0.99)) %>% # Make sure price isn't negative
...
Indie games dropped the most in price (40-60% decline). Sports and Action games held their value better. This probably has to do with big franchises vs lots of indie competition.
...
All the genres showed prices going down from 2015 to 2024, usually dropping 30-50%. Indie games dropped the fastest though, losing  50-60% of their value. Sports and Action games only dropped 20-30% which is probably because franchises like FIFA and Call of Duty hold their value better than random indie titles that have tons of competition.
...
One other thing we noticed is that RPG and Action games have way more price variation than other genres. You have expensive AAA titles and cheap indie games both in those categories. Puzzle games are pretty consistent price-wise.

Overall genre is probably the biggest factor in pricing but everything trends downward over time as games get older and there's more competition.
